            ...
            <div class="hidden md:flex flex-1 justify-center">
                <div class="flex items-center space-x-1">
                    <?php if ($role === 'recipient'): ?>
                        ...
                        <a href="<?= BASE_URL ?>RecipientSpecimenCrud/RecipientSpecimenIndex.php" class="hover:bg-emerald-900 px-4 py-2 rounded-lg text-sm font-bold transition text-emerald-50">
